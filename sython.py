...
async def _(event):
    ...
    await event.edit(f'''
**☆ WELCOME TO NEON
☆ [ Source NEON ](https://t.me/vd_d_dd/20)
☆ VERSION : 2.8
☆ PING : `{ms}`
☆ DATE : `{m9zpi}`
☆ ID : `{event.sender_id}`
☆ SOURCE NEON : @SOURCE_NEON**
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("RR_BU"))
    except BaseException:
        pass
...
async def _(event):
      await event.reply("""السـورس يعمـل | NEON
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/SOURCE_NEON
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""NN OWNER : @R_R_B0"""
)
